	...
	<body>
		...
		<form method="POST">
			<fieldset>
				...
				Title: <input type="text" name="entryTitle" value="<%= entry.getTitle() %>">
				Text: <input type="text" name="entryText" value="<%= entry.getText() %>">
				<input type="hidden" name="pageName" value="editEntryPage">
				<input type="hidden" name="hiddenID" value="<%= entry.getId() %>">
