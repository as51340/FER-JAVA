...
/**
 * Class used for representation of vectors in 2D plane. Provides methods for translating, rotating and scaling vectors. 
 * @author Andi Škrgat
 * @version 1.0
 */
...
public class Vector2D {
	...
	/**
	 * X component for vector in 2D plane
	 */
	private double x;
	
	/**
	 * Y component for vector in 2D plane 
	 */
	private double y;
	
	/**
	 * Constructs a new vector with the given coordinatws
