...
/**
 * Implementation of {@linkplain IWebWorker} that creates a HTML page with current time displayed and it will give a different message depending
 * if a parameter called “name” was provided in URL that started this worker
 * @author Andi Škrgat
 * @version 1.0
 */
